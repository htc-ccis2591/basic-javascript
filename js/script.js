...
var message = "Hello " + name + ", greetings!"
...
for (var i = 0; i < numsArray.length; i++) {
  total = (numsArray[i] + numsArray[i]);
}
    
    //I'm reallly stuck here, I can retrieve the last iteration but am embarrasingly not sure how to perform the math on each value. I've been using a different book that I do like but I'll be purchasing the recommended book at the end of the week.
...
if (total < 50) {
  ...
  console.log("The total is more than 50");
}
else if (total === 50) {
  console.log("The total is 50");
}
}
